...
function Home() {
  ...
  const services = [
    {
      icon: (
        <FaUserDoctor className="text-5xl transition-colors duration-300" />
      ),
      title: "Patient Coordination",
      description:
        "Involves organizing and managing patient care, appointments, and communication for effective treatment processes.",
      link: "/services/patient",
    },
    {
      icon: (
        <IoNewspaperSharp className="text-5xl transition-colors duration-300" />
      ),
      title: "Insurance Eligibility & Benefits",
      description:
        "Determining if a patient qualifies for coverage and what services or treatments are covered, including costs.",
      link: "/services/insurance",
    },
    {
      icon: (
        <FaBookMedical className="text-5xl transition-colors duration-300" />
      ),
      title: "Bookkeeping & Accounting",
      description:
        "Involves recording financial transactions and maintaining accurate financial records for a business.",
      link: "/services/bookkeeping",
    },
    {
      icon: (
        <AiFillClockCircle className="text-5xl transition-colors duration-300" />
      ),
      title: "Pending Claims Management",
      description:
        "Involves tracking, reviewing, and resolving outstanding insurance claims to ensure timely reimbursement.",
    ...
    {
      icon: (
        <FaStethoscope className="text-5xl transition-colors duration-300" />
      ),
      title: "Treatment Coordination",
      description:
        "Managing a patient’s care plan across healthcare providers to ensure smooth and effective treatment.",
      link: "/services/treatment",
    },
    {
      icon: (
        <HiSpeakerphone className="text-5xl transition-colors duration-300" />
      ),
      title: "Marketing Management",
      description:
        "Planning and executing marketing strategies to promote products or services and achieve business objectives.",
    ...
    },
    {
      ...
      description:
        "Sourcing, interviewing, and hiring candidates for various roles to meet business needs effectively.",
    ...
    },
    {
      ...
      description:
        "Analyzing business operations to identify opportunities for improvement and optimize performance.",
  ...
  return (
    <div className="relative">
      ...
      <div className="relative h-[600px]">
        <div className="absolute inset-0">
          ...
          <img
            ...
            className={`object-cover w-full h-[600px] -z-40 object-bottom transition-opacity duration-[2000ms] ease-in-out ${
          ...
          <img
            src={homepage}
            alt="homepage"
            className={`object-cover w-full h-[600px] absolute top-0  object-bottom transition-opacity duration-[2000ms] ease-in-out ${
      ...
      <motion.div
        ...
        className="my-28 p-5"
      >
        <h2 className="text-3xl poppins-bold text-gray-800 text-center">
          Who We Are
        </h2>
        <div className="mt-4 max-w-4xl mx-auto text-center">
          <p className="text-lg text-gray-700 poppins-light-italic">
            ...
            committed to providing exceptional care and support. Our mission is
            to streamline healthcare processes and offer comprehensive solutions
            that <span className="text-orange-500">enhance</span> the patient
            experience and{" "}
            <span className="text-orange-500">
              improve operational efficiency
            </span>
            . With a focus on innovation and compassion, we strive to be a
            leader in the industry, ensuring that every patient receives the
            highest quality of care and attention."
          </p>
        </div>
      </motion.div>
            ...
            {services.map((service, index) => (
              ...
              >
                ...
                >
                  ...
                  {/* Text Column */}
                  <div>
                    <p className="text-xl mb-2 font-bold group-hover:text-white transition-colors duration-300 text-center md:text-left">
                      {" "}
                      {service.title}{" "}
                    </p>
      ...
      <section className="my-16">
        <div className="container flex flex-col items-center p-4 mx-auto space-y-6 md:p-8">
          ...
          <p className="px-6 md:text-lg poppins-light italic text-gray-800 md:px-32 text-center">
            "Exceptional service! Dental Care Connects has streamlined our
            practice with top-notch insurance management and patient
            coordination, allowing us to focus more on delivering quality care."
          </p>
          <div className="flex justify-center space-x-3">
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTPifbSMjy9cWkAjAH-xuPG_MTpfcSbPso5FQ&s"
              alt=""
              className="w-12 h-12 bg-center bg-cover rounded-full dark:bg-gray-500"
            />
            <div>
              <p className="leading-tight poppins-bold">Dr. Rajesh Kapoor</p>
              <p className="text-sm leading-tight dark:text-gray-600">
                Dentist
              </p>
            </div>
          </div>
